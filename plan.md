...
*   **Task: Implement `analyze_pr` Method**
    ...
    *   [ ] Sub-task: Implement Diff Parsing: Parse the raw diff output from `gh pr diff --patch` into a structured format, mapping changes to `FileChange` models (from Phase 2).
