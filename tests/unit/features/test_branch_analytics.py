...
def test_analyze_branch_logic(analyzer: BranchAnalyzer, mock_executor: MagicMock) -> None:
...
def test_analyze_branch_empty(analyzer: BranchAnalyzer, mock_executor: MagicMock) -> None:
