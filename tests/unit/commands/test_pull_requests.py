...
@pytest.fixture
def mock_executor(mocker: Any) -> MagicMock:
    return cast(MagicMock, mocker.Mock(spec=GHExecutor))


def test_pr_manager_list_prs(mock_executor: MagicMock) -> None:
...
def test_pr_manager_list_prs_empty(mock_executor: MagicMock) -> None:
...
def test_pr_manager_get_pr_content(mock_executor: MagicMock) -> None:
...
def test_pr_manager_get_pr_content_empty(mock_executor: MagicMock) -> None:
...
def test_get_pr_diff(mock_executor: MagicMock) -> None:
...
def test_get_pr_diff_with_target_branch(mock_executor: MagicMock) -> None:
...
def test_pr_manager_get_pr_diff_against_branch(mock_executor: MagicMock) -> None:
